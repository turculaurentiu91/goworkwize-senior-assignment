...
final class JamfSyncService implements MdmSyncInterface
{
    ...
    public function sync(): array
    {
        ...
        DB::transaction(function () use ($devices, &$result) {
